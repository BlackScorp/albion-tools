...
| Letzter grüner Build | 2026-09-16 – `make verify` nach T07 |
| Blocker | keine |
...
| T07 Filter/UI-Zustände | ERLEDIGT | `make test`, `make verify` und `git diff --check` erfolgreich; Filter- und Sortierlogik getestet |
